...
COPY . /usr/src/wroe_sdi/
WORKDIR /usr/src/wroe_sdi
...
RUN chmod +x /usr/src/wroe_sdi/tasks.py \
    && chmod +x /usr/src/wroe_sdi/entrypoint.sh
...
ENTRYPOINT service cron restart && service memcached restart && /usr/src/wroe_sdi/entrypoint.sh
