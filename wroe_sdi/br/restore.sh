...
echo "-----------------------------------------------------"
echo "STARTING wroe_sdi RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./wroe_sdi/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED wroe_sdi RESTORE $(date)"
echo "-----------------------------------------------------"
